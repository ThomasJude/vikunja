...
func adminInviteLinksList(ctx context.Context, in *ListParams) (*inviteLinkListBody, error) {
	...
	s := db.NewSession()
	defer s.Close()
	links, total, err := models.ListInviteLinksAsAdmin(s, doer, in.Page, in.PerPage)
	if err != nil {
